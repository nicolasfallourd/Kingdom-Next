...
export async function testSupabase() {
  try {
    ...
    // Simple ping test - just try to fetch a single row from game_states
    ...
    if (error) {
      console.error('*** KINGDOM DEBUG: Supabase connection test failed ***', error);
      return { success: false, error: error.message };
    }
    
    console.log('*** KINGDOM DEBUG: Supabase connection test successful ***', data);
